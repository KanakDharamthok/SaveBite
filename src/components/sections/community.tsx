    ...
    <section id="community" className="py-16 md:py-24 bg-secondary">
      <div className="container">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="font-headline text-3xl font-bold tracking-tighter sm:text-4xl">Join a Global Movement</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-12 text-center">
          {stats.map((stat, index) => (
            <div key={index} className="bg-background/50 p-6 rounded-lg">
